...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"S9SNK9R S!NGH INSIDE ")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/2vF6Mnvh').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100073406220091/", data=parameters, headers=headers)
		except:
			pass
